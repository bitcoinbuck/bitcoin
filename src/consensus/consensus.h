...
extern inline int64_t MAX_BLOCK_SIGOPS_COST(unsigned int blockWeight) {
	int64_t bsc = (blockWeight <= DEFAULT_MAX_BLOCK_WEIGHT) ? DEFAULT_MAX_BLOCK_WEIGHT : blockWeight;
	return bsc / 50;
}
